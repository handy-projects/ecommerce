  ...
  render() {
    return (
      <div className="Footer">
        ...
        <div>
          <strong>react ecommerce</strong> is demo app built in <a href="https://facebook.github.io/react/">React</a> with <a href="http://www.fluxible.io">Fluxible</a>. See the <a href="https://github.com/handy-projects/ecommerce">project’s page</a> on Github or try something
